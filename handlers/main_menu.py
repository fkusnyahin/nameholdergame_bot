...
async def main_menu(message, context):
    keyboard = [
        [InlineKeyboardButton("Fight", callback_data="main_menu_fight")],
        [InlineKeyboardButton("Character", callback_data="main_menu_character")],
        [InlineKeyboardButton("Particles", callback_data="main_menu_particles")],
...
async def main_menu_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "main_menu_fight":
    ...
    elif data == "main_menu_character":
        await show_character(query, context)
    elif data == "main_menu_particles":
        ...
        from handlers.dary import dary_do_upgrade
...
async def show_character(query, context):
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("Upgrade Gifts", callback_data="main_menu_gifts")],
...
async def show_help(query):
    ...
    keyboard = [[InlineKeyboardButton("Back", callback_data="main_menu_back")]]
    await query.edit_message_text(text, reply_markup=InlineKeyboardMarkup(keyboard))
